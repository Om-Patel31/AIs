...
print("Please wait before speaking, it might take a while to load. Speak once it shows this text 'Listening....'. Thank you")
...
def TaskExecution():
    ...
    while True:
        ...
        # elif ("where" and "am") or "location" in query:
